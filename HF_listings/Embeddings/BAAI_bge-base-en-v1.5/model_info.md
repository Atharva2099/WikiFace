...
- **Author**: BAAI
- **Last Updated**: 2024-02-21 03:00:19+00:00
- **Repository**: https://huggingface.co/BAAI/bge-base-en-v1.5
...
- **.gitattributes** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/.gitattributes](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/.gitattributes)
- **1_Pooling/config.json** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/1_Pooling/config.json](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/1_Pooling/config.json)
- **README.md** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/README.md](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/README.md)
- **config.json** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/config.json](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/config.json)
- **config_sentence_transformers.json** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/config_sentence_transformers.json](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/config_sentence_transformers.json)
- **model.safetensors** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/model.safetensors](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/model.safetensors)
- **modules.json** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/modules.json](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/modules.json)
- **onnx/model.onnx** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/onnx/model.onnx](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/onnx/model.onnx)
- **pytorch_model.bin** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/pytorch_model.bin](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/pytorch_model.bin)
- **sentence_bert_config.json** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/sentence_bert_config.json](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/sentence_bert_config.json)
- **special_tokens_map.json** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/special_tokens_map.json](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/special_tokens_map.json)
- **tokenizer.json** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/tokenizer.json](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/tokenizer.json)
- **tokenizer_config.json** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/tokenizer_config.json](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/tokenizer_config.json)
- **vocab.txt** (None bytes)
  - Download: [https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/vocab.txt](https://huggingface.co/BAAI/bge-base-en-v1.5/resolve/main/vocab.txt)


## External Links

- [arxiv.org](https://arxiv.org/abs/2311.13534)
- [arxiv.org](https://arxiv.org/abs/2312.15503)
- [arxiv.org](https://arxiv.org/abs/2401.03462)
- [arxiv.org](https://arxiv.org/pdf/2309.07597.pdf)
- [arxiv.org](https://arxiv.org/pdf/2310.07554.pdf)
- [data.baai.ac.cn](https://data.baai.ac.cn/details/BAAI-MTP)
- [github.com](https://github.com/FlagOpen/FlagEmbedding)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/blob/master/C_MTEB)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/blob/master/C_MTEB/)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/blob/master/C_MTEB/README.md)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/blob/master/FlagEmbedding/BGE_M3/BGE_M3.pdf)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/blob/master/FlagEmbedding/baai_general_embedding/README.md)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/blob/master/LICENSE)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/blob/master/README_zh.md)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master#model-list)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/C_MTEB)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/BGE_M3)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/BGE_M3#usage)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/baai_general_embedding)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/llm_embedder)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/reranker)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/LM_Cocktail)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/Long_LLM/activation_beacon)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune#hard-negatives)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/pretrain)
- [github.com](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/reranker)
- [github.com](https://github.com/michaelfeil/infinity)
- [github.com](https://github.com/staoxiao/RetroMAE)
- [huggingface.co](https://huggingface.co/BAAI/bge-base-en)
- [huggingface.co](https://huggingface.co/BAAI/bge-base-en-v1.5)
- [huggingface.co](https://huggingface.co/BAAI/bge-base-zh)
- [huggingface.co](https://huggingface.co/BAAI/bge-base-zh-v1.5)
- [huggingface.co](https://huggingface.co/BAAI/bge-large-en)
- [huggingface.co](https://huggingface.co/BAAI/bge-large-en-v1.5)
- [huggingface.co](https://huggingface.co/BAAI/bge-large-zh)
- [huggingface.co](https://huggingface.co/BAAI/bge-large-zh-noinstruct)
- [huggingface.co](https://huggingface.co/BAAI/bge-large-zh-v1.5)
- [huggingface.co](https://huggingface.co/BAAI/bge-m3)
- [huggingface.co](https://huggingface.co/BAAI/bge-reranker-base)
- [huggingface.co](https://huggingface.co/BAAI/bge-reranker-large)
- [huggingface.co](https://huggingface.co/BAAI/bge-small-en)
- [huggingface.co](https://huggingface.co/BAAI/bge-small-en-v1.5)
- [huggingface.co](https://huggingface.co/BAAI/bge-small-zh)
- [huggingface.co](https://huggingface.co/BAAI/bge-small-zh-v1.5)
- [huggingface.co](https://huggingface.co/BAAI/llm-embedder)
- [huggingface.co](https://huggingface.co/GanymedeNil/text2vec-large-chinese)
- [huggingface.co](https://huggingface.co/bigscience/sgpt-bloom-7b1-msmarco)
- [huggingface.co](https://huggingface.co/hkunlp/instructor-xl)
- [huggingface.co](https://huggingface.co/intfloat/e5-base-v2)
- [huggingface.co](https://huggingface.co/intfloat/e5-large-v2)
- [huggingface.co](https://huggingface.co/intfloat/multilingual-e5-base)
- [huggingface.co](https://huggingface.co/intfloat/multilingual-e5-large)
- [huggingface.co](https://huggingface.co/intfloat/multilingual-e5-small)
- [huggingface.co](https://huggingface.co/moka-ai/m3e-base)
- [huggingface.co](https://huggingface.co/moka-ai/m3e-large)
- [huggingface.co](https://huggingface.co/sentence-transformers/all-mpnet-base-v2)
- [huggingface.co](https://huggingface.co/sentence-transformers/sentence-t5-xxl)
- [huggingface.co](https://huggingface.co/shibing624/text2vec-base-chinese)
- [huggingface.co](https://huggingface.co/silk-road/luotuo-bert-medium)
- [huggingface.co](https://huggingface.co/spaces/mteb/leaderboard)
- [huggingface.co](https://huggingface.co/thenlper/gte-base)
- [huggingface.co](https://huggingface.co/thenlper/gte-large)
- [huggingface.co](https://huggingface.co/thenlper/gte-small)
- [platform.openai.com](https://platform.openai.com/docs/guides/embeddings)
- [platform.openai.com](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings)
...
*Generated on 2025-06-21 15:07:52*
