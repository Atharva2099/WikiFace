...
- **Author**: jinaai
- **Last Updated**: 2025-02-24 07:06:37+00:00
- **Repository**: https://huggingface.co/jinaai/jina-embeddings-v3
...
- **.gitattributes** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/.gitattributes](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/.gitattributes)
- **1_Pooling/config.json** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/1_Pooling/config.json](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/1_Pooling/config.json)
- **README.md** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/README.md](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/README.md)
- **config.json** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/config.json](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/config.json)
- **config_sentence_transformers.json** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/config_sentence_transformers.json](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/config_sentence_transformers.json)
- **custom_st.py** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/custom_st.py](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/custom_st.py)
- **model.safetensors** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/model.safetensors](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/model.safetensors)
- **modules.json** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/modules.json](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/modules.json)
- **onnx/model.onnx** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/onnx/model.onnx](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/onnx/model.onnx)
- **onnx/model.onnx_data** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/onnx/model.onnx_data](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/onnx/model.onnx_data)
- **onnx/model_fp16.onnx** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/onnx/model_fp16.onnx](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/onnx/model_fp16.onnx)
- **pytorch_model.bin** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/pytorch_model.bin](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/pytorch_model.bin)
- **special_tokens_map.json** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/special_tokens_map.json](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/special_tokens_map.json)
- **tokenizer.json** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/tokenizer.json](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/tokenizer.json)
- **tokenizer_config.json** (None bytes)
  - Download: [https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/tokenizer_config.json](https://huggingface.co/jinaai/jina-embeddings-v3/resolve/main/tokenizer_config.json)


## External Links

- [aws.amazon.com](https://aws.amazon.com/marketplace/pp/prodview-kdi3xkt62lo32)
- [azuremarketplace.microsoft.com](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/jinaai.jina-embeddings-v3-vm)
- [discord.jina.ai](https://discord.jina.ai)
- [github.com](https://github.com/Dao-AILab/flash-attention)
- [github.com](https://github.com/UKPLab/sentence-transformers)
- [huggingface.co](https://huggingface.co/jinaai/jina-embeddings-v3/discussions/60)
- [huggingface.co](https://huggingface.co/jinaai/xlm-roberta-flash-implementation)
- [jina.ai](https://jina.ai/contact-sales/)
- [jina.ai](https://jina.ai/embeddings)
- [jina.ai](https://jina.ai/embeddings/)
- [jina.ai](https://jina.ai/news/jina-embeddings-v3-a-frontier-multilingual-embedding-model/#parameter-dimensions)
- [sbert.net](https://sbert.net/docs/package_reference/sentence_transformer/trainer.html)
...
*Generated on 2025-06-21 15:07:51*
