# GitHub Data for microsoft_table-transformer-structure-recognition
...
- 🟢 **#200** Table Extraction Header and Column Merge Issue (open)
- 🟢 **#199** Convert .pth to safetensors (open)
- 🟢 **#198** Bugfix filepathes in process_scitsr.py (open)
- 🔴 **#197** Question about fine-tuning model with my own dataset ? (closed)
- 🟢 **#196** Urgent Assistance Needed (open)

## Recent Pull Requests

- 🟢 **#198** Bugfix filepathes in process_scitsr.py (open)
- 🟢 **#195** Correction to IOU calcuation (open)
- 🟢 **#193** Bugfix area given boxes in Pascal format (open)
- 🟢 **#188** Fix: visualization of cells structure in inference.py (open)
- 🟢 **#184** Bugfix when extracting tokens for multiple detected objects (open)
